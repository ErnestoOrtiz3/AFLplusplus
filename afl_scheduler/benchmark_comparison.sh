...
run_benchmark() {
    ...
    for i in $(seq 1 "$NUM_INSTANCES"); do
        ...
        # Start AFL++ instance
        sudo AFL_NO_AFFINITY=1 AFL_TMPDIR="$TMP_DIR" /home/ernesto/Documents/AFLplusplus/afl-fuzz -i /home/ernesto/Documents/AFLplusplus/split_seeds -o "$output_dir" \
