...
run_benchmark() {
    ...
    /home/ernesto/Documents/AFLplusplus/afl_scheduler/stats_collector "$output_dir" &
    STATS_PID=$!
...
python3 /home/ernesto/Documents/AFLplusplus/afl_scheduler/compare_results.py "$RESULTS_DIR/custom" "$RESULTS_DIR/cfs" > "$RESULTS_DIR/comparison_report.txt"
